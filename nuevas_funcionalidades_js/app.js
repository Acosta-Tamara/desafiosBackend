...
/* includes para verificar si hay un valor dentro del arreglo
...
const persona = {
 ...
 /* spread Operator - me trae todo el contenido de numeros y añade los nuevos valores
 const numeros = [1,2,3]
 ...
 /* Actividad
  ...
  class TicketManager {
    ...
    ponerEventoEnGira(evento_id, nueva_localidad, nueva_fecha){
        const evento_encontrado = this.eventos.find((evento) => evento_id === evento_id)
        if (!evento_encontrado){
